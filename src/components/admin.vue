                        ...
                        <div class="app-page-title">
                                ...
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            ...
                                            <div class="widget-subheading">Verified Users</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span>{{ this.totalUsers }}  </span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Ltc networth</div>
                                            <div class="widget-subheading">non-inclusive cashouts</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span> $ {{ this.ltcnetworth }}</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-xl-none d-lg-block col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">ltc Withdrawals</div>
                                            <div class="widget-subheading">total</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-warning"><span>${{ this.ltcout }}</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                             <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Btc networth</div>
                                            <div class="widget-subheading">non-inclusive cashouts </div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span> $ {{ this.btcnetworth }}</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                             <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Btc withdrawals</div>
                                            <div class="widget-subheading"> total </div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-danger"><span> $ {{ this.btcout }}</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-outer">
                                        <div class="widget-content-wrapper">
                                            ...
                                            <div class="widget-content-right">
                                                <div class="widget-numbers text-success">{{ this.orders }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="widget-content-outer">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                ...
                                                <div class="widget-subheading">Crypto totals</div>
                                            </div>
                                            <div class="widget-content-right">
                                                <div class="widget-numbers text-focus">$ {{ this.ltcnetworth + this.btcnetworth }}</div>
                                            </div>
                                        </div>
                                        <div class="widget-progress-wrapper">
                                            ...
                                            <div class="progress-sub-label">
                                                <div class="sub-label-left">GasFee</div>
                                                <div class="sub-label-right">$ {{ this.gasfee }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Unconfirmed Deposits
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr v-for="bid in bids" :key="bid.id">
                                                ...
                                                <td class="text-center">{{ bid.email}}</td>
                                                       <td class="text-center">{{ bid.package}}</td>
                                                <td class="text-center">
                                                    <div class="badge badge-warning">{{ bid.verification_status}}</div>
                                                </td>
                                                <td class="text-center">
...
export default {
  ...
  mounted: function () {
    ...
    db.collection('bids').get().then(snapshot => {
      ...
      db.collection('bids').where('verification_status', '==', 'unverified').get().then(snapshot => {
        snapshot.forEach(doc => {
