                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header"> Your Direct Downline
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">Commission Earned</th>
                                                <!-- <th class="text-center">SignedUp At</th>
                                            ...
                                            <tr v-for="bid in bids" :key="bid.id">
                                                <td class="text-center text-muted">{{ bid.username}}</td>
                                                   <td class="text-center text-muted">${{ bid.bonus}}</td>
                                                <!-- <td class="text-center">{{  getCreatedAtDate(id)}}</td>
                                                       <td class="text-center"><div class="badge badge-info">{{ getPackage()}}</div></td> -->
