  ...
  <div class="col-xs-4 col-sm-6 col-md-5 col-lg-4 col-xl-3">
    <div class="card shadow-lg">
      ...
      <div class="card-body px-0">
        <p class="text-center"><small><strong>31r5QreLwu1aFHR7WNdSZVovMXPNyJ4xAf</strong></small></p>
        <p class="text-muted text-center">Scan QR code and top-up your<br>
          After payments email the admin<br> <sub><b>dreamcreation74@gmail.com</b></sub> <br>for confirmation<br>
          Payment will be credited after confirmation by the admin.<br>
        </p>
      </div>
    </div>
  </div>
