                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">USER Accounts
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">Btcbalance</th>
                                                <th class="text-center">LtcBalance</th>
                                            ...
                                            <tr v-for="user in users" :key="user.id">
                                                ...
                                                <td class="text-center">{{ user.email}}</td>
                                                     <td class="text-center">{{ user.phonenumber}}</td>
                                                       <td class="text-center">${{ user.btcbalance}}</td>
                                                <td class="text-center">${{ user.ltcbalance }}</td>
                                                <td class="text-center">$ {{ user.commission }}</td>
                                                <td class="text-center">$ {{user.expenses }}</td>
